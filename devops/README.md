...
DEPLOY_ENV=prod
DEPLOY_HOST=portal-agencia.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for portal-agencia.example.com, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    portal-agencia.example.com:
      ansible_user: root
      host: portal-agencia
      hostname: portal-agencia.example.com
```
...
Deploy the stack defined in `devops/stacks/portal-agencia.example.com.yml` to the remote server with:
