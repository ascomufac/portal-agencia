...
2. Go to your repository at [ascomufac/portal-agencia](https://github.com/ascomufac/portal-agencia).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `portal-agencia.example.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | portal-agencia.example.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | portal-agencia.example.com |
...
- [Backend Tests Workflow](https://github.com/ascomufac/portal-agencia/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/ascomufac/portal-agencia/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/ascomufac/portal-agencia-backend`) and Frontend (`ghcr.io/ascomufac/portal-agencia-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of portal-agencia.example.com](https://github.com/ascomufac/portal-agencia/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/portal-agencia.example.com.yml` stack.
